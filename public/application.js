	...
	(0, _jquery2['default'])(function () {
	  ...
	  var app = {
	    ...
	    render: function render() {
	      ...
	      */
	      app.unbindEvents();
	      (0, _jquery2['default'])('ul.list-group').html(todohtml.join('')); // fill the DOM
	      app.bindEvents();
	    },
	    compileTemplates: function compileTemplates() {
	      template = (0, _jquery2['default'])('[type="text/x-template"]');
	      template = _handlebars2['default'].compile(template.first().html()); // grabbing the first content in the HTML template
	    },
	    ...
	    bindHoverEvents: function bindHoverEvents() {
	      var $items = (0, _jquery2['default'])('.list-group-item'); // assign to $items so we don't call twice
